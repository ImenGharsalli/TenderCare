...
public class Job {
	...
	private UUID jobid;
	@Column(value = "jobfunction")
	private String jobFunction;
	@Column(value = "description")
	private String description;
	@Column(value = "location")
	private String location;
	@PrimaryKeyColumn(value = "postdate", ordinal = 1, type = PrimaryKeyType.CLUSTERED, ordering = Ordering.DESCENDING)
	private String postDate;
	@Column(value = "expirationDate")
	private String expirationDate;
	@Column(value = "estimatedbudget")
	private float estimatedBudget;
	@Column(value = "user")
	private UUID user;
	@Column(value = "userFirstName")
